  ...
  return (
    <div className="cmp-container">
      ...
      <main className="container responsivegrid">
        <div className="cmp-container">
          <TeaserHero src={main1}>Welcome to JIHUN</TeaserHero>
          <Title>
            <h1 className="cmp-title__text">Profile</h1>
          </Title>
          <div className="teaser hero hero--normal content-on-top content-on-left">
            ...
            <div className="cmp-container">
              ...
              <div className="container responsivegrid grid three-columns">
                <div className="cmp-container">
                  ...
                  <SkillCard title="Pjh-Portfolio" src={main1} showActionLink={true} href="https://pjh-portfolio.netlify.app/">
